...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Projects */}
      <section id="projects" className="max-w-6xl mx-auto px-6 pb-24 lg:pb-32">
      ...
      <footer className="border-t border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-text-tertiary text-sm">
