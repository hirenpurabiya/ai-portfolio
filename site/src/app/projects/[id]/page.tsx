          ...
          <div className="flex items-center gap-2">
            ...
            {project.huggingface && (
              ...
              >
                ...
                >
                  <path d="M47.2 0C26.3 0 8.8 16 6.2 36.7c-1.5 11.8 1.7 23.3 8.8 32.3 7.2 9 17.8 14.8 29.5 16.2h5.4c11.7-1.4 22.3-7.2 29.5-16.2 7.2-9 10.3-20.5 8.8-32.3C85.5 16 68 0 47.2 0zm-20 52.8c-3.5 0-6.4-2.9-6.4-6.4s2.9-6.4 6.4-6.4 6.4 2.9 6.4 6.4-2.9 6.4-6.4 6.4zm40 0c-3.5 0-6.4-2.9-6.4-6.4s2.9-6.4 6.4-6.4 6.4 2.9 6.4 6.4-2.9 6.4-6.4 6.4zm5.6 11.2c-5.5 8.2-14.5 13.2-24.2 13.2h-2.4c-9.7 0-18.7-5-24.2-13.2-1-1.5-.6-3.5.9-4.5s3.5-.6 4.5.9c4.3 6.4 11.3 10.2 18.8 10.2h2.4c7.5 0 14.5-3.8 18.8-10.2 1-1.5 3-1.9 4.5-.9 1.4 1 1.9 3 .9 4.5z" fill="currentColor"/>
                </svg>
                MCP Server
              </a>
            )}
            {project.demo && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 whitespace-nowrap px-3 py-2 rounded-full bg-accent text-white text-xs sm:text-sm hover:bg-accent-hover transition-colors duration-300"
              >
                <svg
                  className="w-3.5 h-3.5 shrink-0"
                  fill="none"
